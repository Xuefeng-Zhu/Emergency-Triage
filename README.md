...
- [er-triage-agent-scope.md](docs/er-triage-agent-scope.md) — architecture contract and design intent. Source of truth.
- [native-gb10-runbook.md](docs/native-gb10-runbook.md) — bootstrap and the stub → live cutover.
- [policy-proof-console.md](docs/policy-proof-console.md) — the enforcement window and its beat sheet.
- [lane3-live-testing.md](docs/lane3-live-testing.md) — live-mode verification without STT.
